...
class TestFinetune(unittest.TestCase):
    ...
    def test_finetune_cobia_new_data_path_missing(self, mock_exists):
        mock_exists.side_effect = lambda path: path != 'new_data.csv'
    ...
    @patch('os.path.exists')
    def test_finetune_oyster_new_data_path_missing(self, mock_exists):
        mock_exists.side_effect = lambda path: path != 'new_data.csv'
